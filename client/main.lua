        ...
        if not isDoingAction then
            ...
            Citizen.CreateThread(function ()
                ...
                while isDoingAction do
                    ...
                    if IsControlJustPressed(0, Keys[Config.cancelButton]) and Action.canCancel then
            ...
            notifiactionStyles(Translation[Config.Lang].progress_already_doing_something, 'error', 4000)
        end
    else
        notifiactionStyles(Translation[Config.Lang].progress_cant_do_that, 'error', 4000)
    end
end
